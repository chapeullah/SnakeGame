...
class AudioManager {
    ...
    AudioManager(){
        musicChillGuy.openFromFile("C:/projects/Snake/assets/audio/ChillGuyTheme.ogg");
        soundUIClick.openFromFile("C:/projects/Snake/assets/audio/ClickStereo.ogg");
        soundFoodPop.openFromFile("C:/projects/Snake/assets/audio/SnesPop.ogg");
...
class UserInterface {    
    ...
    UserInterface() : currentProject{"C:/projects/Snake/"}, releasedItem{0}, containItem {0}, pressedItem{0}, inGameContain{0}, inGamePressed{0}, inGameReleased{0}, logregReleasedItem{0}, isGamePaused{false}{
        Texture2Sprite(background, backgroundSprite, currentProject + "assets/sprites/background.png", 0, 0);
        Texture2Sprite(backgroundm, backgroundmSprite, currentProject + "assets/sprites/backgroundm.png", 720, 260);
        Texture2Sprite(backgroundmblur, backgroundmblurSprite, currentProject + "assets/sprites/backgroundmblur.png", 735, 275);
        Texture2Sprite(backgroundAYS, backgroundAYSSprite, currentProject + "assets/sprites/backgroundAYS.png", 680, 405);
        Texture2Sprite(textBACK, textBACKSprite1, currentProject + "assets/sprites/textBACK.png", 750, 300);
        Texture2Sprite(textBACK, textBACKSprite2, currentProject + "assets/sprites/textBACK.png", 750, 425);
        Texture2Sprite(textBACK, textBACKSprite3, currentProject + "assets/sprites/textBACK.png", 750, 550);
        Texture2Sprite(textBACK, textBACKSprite4, currentProject + "assets/sprites/textBACK.png", 750, 675);
        Texture2Sprite(textBACKpressed, textBACKpressedSprite1, currentProject + "assets/sprites/textBACKpressed.png", 750, 300);
        Texture2Sprite(textBACKpressed, textBACKpressedSprite2, currentProject + "assets/sprites/textBACKpressed.png", 750, 425);
        Texture2Sprite(textBACKpressed, textBACKpressedSprite3, currentProject + "assets/sprites/textBACKpressed.png", 750, 550);
        Texture2Sprite(textBACKpressed, textBACKpressedSprite4, currentProject + "assets/sprites/textBACKpressed.png", 750, 675);
        Texture2Sprite(textgoals, textgoalsSprite, currentProject + "assets/sprites/textgoals.png", 878, 572);
        Texture2Sprite(textgoalscontain, textgoalscontainSprite, currentProject + "assets/sprites/textgoalscontain.png", 878, 572);
        Texture2Sprite(textquit, textquitSprite1, currentProject + "assets/sprites/textquit.png", 856, 697);
        Texture2Sprite(textquit, textquitSprite2, currentProject + "assets/sprites/textquit.png", 856, 572);
        Texture2Sprite(textquitcontain, textquitcontainSprite1, currentProject + "assets/sprites/textquitcontain.png", 856, 697);
        Texture2Sprite(textquitcontain, textquitcontainSprite2, currentProject + "assets/sprites/textquitcontain.png", 856, 572);
        Texture2Sprite(textsetup, textsetupSprite, currentProject + "assets/sprites/textsetup.png", 817, 447);
        Texture2Sprite(textsetupcontain, textsetupcontainSprite, currentProject + "assets/sprites/textsetupcontain.png", 817, 447);
        Texture2Sprite(textstart, textstartSprite, currentProject + "assets/sprites/textstart.png", 817, 322);
        Texture2Sprite(textstartcontain, textstartcontainSprite, currentProject + "assets/sprites/textstartcontain.png", 817, 322);
        Texture2Sprite(noback, nobackSprite, currentProject + "assets/sprites/noback.png", 970, 550);
        Texture2Sprite(nobackdark, nobackdarkSprite, currentProject + "assets/sprites/nobackdark.png", 970, 550);
        Texture2Sprite(nored, noredSprite1, currentProject + "assets/sprites/nored.png", 1042, 572);
        Texture2Sprite(nored, noredSprite2, currentProject + "assets/sprites/nored.png", 787, 728);
        Texture2Sprite(nowhite, nowhiteSprite1, currentProject + "assets/sprites/nowhite.png", 1042, 572);
        Texture2Sprite(nowhite, nowhiteSprite2, currentProject + "assets/sprites/nowhite.png", 787, 728);
        Texture2Sprite(yesback, yesbackSprite, currentProject + "assets/sprites/yesback.png", 700, 550);
        Texture2Sprite(yesbackdark, yesbackdarkSprite, currentProject + "assets/sprites/yesbackdark.png", 700, 550);
        Texture2Sprite(yesgreen, yesgreenSprite, currentProject + "assets/sprites/yesgreen.png", 743, 572);
        Texture2Sprite(yeswhite, yeswhiteSprite, currentProject + "assets/sprites/yeswhite.png", 743, 572);
        Texture2Sprite(exit, exitSprite, currentProject + "assets/sprites/exit.png", 825, 447);
        Texture2Sprite(snakeback, snakebackSprite, currentProject + "assets/sprites/snakeback.png", 90, 82);
        Texture2Sprite(score, scoreSprite, currentProject + "assets/sprites/score.png", 120, 112);
        Texture2Sprite(zero, zeroSprite, currentProject + "assets/sprites/0zero.png");
        Texture2Sprite(one, oneSprite, currentProject + "assets/sprites/1one.png");
        Texture2Sprite(two, twoSprite, currentProject + "assets/sprites/2two.png");
        Texture2Sprite(three, threeSprite, currentProject + "assets/sprites/3three.png");
        Texture2Sprite(four, fourSprite, currentProject + "assets/sprites/4four.png");
        Texture2Sprite(five, fiveSprite, currentProject + "assets/sprites/5five.png");
        Texture2Sprite(six, sixSprite, currentProject + "assets/sprites/6six.png");
        Texture2Sprite(seven, sevenSprite, currentProject + "assets/sprites/7seven.png");
        Texture2Sprite(eight, eightSprite, currentProject + "assets/sprites/8eight.png");
        Texture2Sprite(nine, nineSprite, currentProject + "assets/sprites/9nine.png");
        Texture2Sprite(inGameSettingsBACK, inGameSettingsBACKSprite, currentProject + "assets/sprites/inGameSettings/inGameSettingsBACK.png", 1740, 113);
        Texture2Sprite(inGameSettingsBACKpressed, inGameSettingsBACKpressedSprite, currentProject + "assets/sprites/inGameSettings/inGameSettingsBACKpressed.png", 1740, 113);
        Texture2Sprite(inGameSettingsFRONT, inGameSettingsFRONTSprite, currentProject + "assets/sprites/inGameSettings/inGameSettingsFRONT.png", 1748, 121);
        Texture2Sprite(inGameSettingsFRONTcont, inGameSettingsFRONTcontSprite, currentProject + "assets/sprites/inGameSettings/inGameSettingsFRONTcont.png", 1748, 121);
        Texture2Sprite(locked, lockedSprite, currentProject + "assets/sprites/inGameSettings/locked.png", 1756, 125);
        Texture2Sprite(block0, block0Sprite, currentProject + "assets/sprites/inGameSettings/block0.png", 1744, 117);
        Texture2Sprite(block1, block1Sprite, currentProject + "assets/sprites/inGameSettings/block1.png", 1744, 117);
        Texture2Sprite(block2, block2Sprite, currentProject + "assets/sprites/inGameSettings/block2.png", 1744, 117);
        Texture2Sprite(block3, block3Sprite, currentProject + "assets/sprites/inGameSettings/block3.png", 1744, 117);
        Texture2Sprite(block4, block4Sprite, currentProject + "assets/sprites/inGameSettings/block4.png", 1744, 117);
        Texture2Sprite(block5, block5Sprite, currentProject + "assets/sprites/inGameSettings/block5.png", 1744, 117);
        Texture2Sprite(block6, block6Sprite, currentProject + "assets/sprites/inGameSettings/block6.png", 1744, 117);
        Texture2Sprite(block7, block7Sprite, currentProject + "assets/sprites/inGameSettings/block7.png", 1744, 117);
        Texture2Sprite(block8, block8Sprite, currentProject + "assets/sprites/inGameSettings/block8.png", 1744, 117);
        Texture2Sprite(block9, block9Sprite, currentProject + "assets/sprites/inGameSettings/block9.png", 1744, 117);
        Texture2Sprite(block10, block10Sprite, currentProject + "assets/sprites/inGameSettings/block10.png", 1744, 117);
        Texture2Sprite(block11, block11Sprite, currentProject + "assets/sprites/inGameSettings/block11.png", 1744, 117);
        Texture2Sprite(block12, block12Sprite, currentProject + "assets/sprites/inGameSettings/block12.png", 1744, 117);
        Texture2Sprite(block13, block13Sprite, currentProject + "assets/sprites/inGameSettings/block13.png", 1744, 117);
        Texture2Sprite(block14, block14Sprite, currentProject + "assets/sprites/inGameSettings/block14.png", 1744, 117);
        Texture2Sprite(block15, block15Sprite, currentProject + "assets/sprites/inGameSettings/block15.png", 1744, 117);
        Texture2Sprite(CLS, CLSSprite, currentProject + "assets/sprites/CLS.png", 567, 572);
        Texture2Sprite(CLSwhite, CLSwhiteSprite, currentProject + "assets/sprites/CLSwhite.png", 567, 572);
        Texture2Sprite(INF, INFSprite, currentProject + "assets/sprites/INF.png", 886, 572);
        Texture2Sprite(INFwhite, INFwhiteSprite, currentProject + "assets/sprites/INFwhite.png", 886, 572);
        Texture2Sprite(ARC, ARCSprite, currentProject + "assets/sprites/ARC.png", 1187, 572);
        Texture2Sprite(ARCwhite, ARCwhiteSprite, currentProject + "assets/sprites/ARCwhite.png", 1187, 572);
        Texture2Sprite(selectmodeBACK, selectmodeBACKSprite, currentProject + "assets/sprites/selectmodeBACK.png", 480, 395);
        Texture2Sprite(selectsmodesBACK, selectsmodesBACK1Sprite, currentProject + "assets/sprites/selectsmodesBACK.png", 510, 550);
        Texture2Sprite(selectsmodesBACK, selectsmodesBACK2Sprite, currentProject + "assets/sprites/selectsmodesBACK.png", 820, 550);
        Texture2Sprite(selectsmodesBACK, selectsmodesBACK3Sprite, currentProject + "assets/sprites/selectsmodesBACK.png", 1130, 550);
        Texture2Sprite(selectsmodesBACKpressed, selectsmodesBACK1pressedSprite, currentProject + "assets/sprites/selectsmodesBACKpressed.png", 510, 550);
        Texture2Sprite(selectsmodesBACKpressed, selectsmodesBACK2pressedSprite, currentProject + "assets/sprites/selectsmodesBACKpressed.png", 820, 550);
        Texture2Sprite(selectsmodesBACKpressed, selectsmodesBACK3pressedSprite, currentProject + "assets/sprites/selectsmodesBACKpressed.png", 1130, 550);
        Texture2Sprite(textselectmode, textselectmodeSprite, currentProject + "assets/sprites/textselectmode.png", 638, 440);
        Texture2Sprite(selectmodeESCBACK, selectmodeESCBACKSprite, currentProject + "assets/sprites/selectmodeESCBACK.png", 490, 405);
        Texture2Sprite(selectmodeESCBACKpressed, selectmodeESCBACKpressedSprite, currentProject + "assets/sprites/selectmodeESCBACKpressed.png", 490, 405);
        Texture2Sprite(selectmodeESC, selectmodeESCSprite, currentProject + "assets/sprites/selectmodeESC.png", 494, 409);
        Texture2Sprite(selectmodeESCcont, selectmodeESCcontSprite, currentProject + "assets/sprites/selectmodeESCcont.png", 494, 409);
        Texture2Sprite(chose0, chose0Sprite, currentProject + "assets/sprites/Setup/chose0.png", 750, 550);
        Texture2Sprite(chose1, chose1Sprite, currentProject + "assets/sprites/Setup/chose1.png", 890, 550);
        Texture2Sprite(chose2, chose2Sprite, currentProject + "assets/sprites/Setup/chose2.png", 1030, 550);
        Texture2Sprite(music, musicSprite, currentProject + "assets/sprites/Setup/music.png", 772, 322);
        Texture2Sprite(musicCont, musicContSprite, currentProject + "assets/sprites/Setup/musicCont.png", 772, 322);
        Texture2Sprite(musicOFF, musicOFFSprite, currentProject + "assets/sprites/Setup/musicOFF.png", 1089, 308);
        Texture2Sprite(musicON, musicONSprite, currentProject + "assets/sprites/Setup/musicON.png", 1089, 308);
        Texture2Sprite(sound, soundSprite, currentProject + "assets/sprites/Setup/sound.png", 772, 447);
        Texture2Sprite(soundCont, soundContSprite, currentProject + "assets/sprites/Setup/soundCont.png", 772, 447);
        Texture2Sprite(soundOFF, soundOFFSprite, currentProject + "assets/sprites/Setup/soundOFF.png", 1089, 438);
        Texture2Sprite(soundON0, soundON0Sprite, currentProject + "assets/sprites/Setup/soundON0.png", 1089, 438);
        Texture2Sprite(soundON1, soundON1Sprite, currentProject + "assets/sprites/Setup/soundON1.png", 1089, 438);
        Texture2Sprite(soundON2, soundON2Sprite, currentProject + "assets/sprites/Setup/soundON2.png", 1089, 438);
        Texture2Sprite(speedBACK0, speedBACK0Sprite, currentProject + "assets/sprites/Setup/speedBACK0.png", 750, 550);
        Texture2Sprite(speedBACK0pressed, speedBACK0pressedSprite, currentProject + "assets/sprites/Setup/speedBACK0pressed.png", 750, 550);
        Texture2Sprite(speedBACK1, speedBACK1Sprite, currentProject + "assets/sprites/Setup/speedBACK1.png", 890, 550);
        Texture2Sprite(speedBACK1pressed, speedBACK1pressedSprite, currentProject + "assets/sprites/Setup/speedBACK1pressed.png", 890, 550);
        Texture2Sprite(speedBACK2, speedBACK2Sprite, currentProject + "assets/sprites/Setup/speedBACK2.png", 1030, 550);
        Texture2Sprite(speedBACK2pressed, speedBACK2pressedSprite, currentProject + "assets/sprites/Setup/speedBACK2pressed.png", 1030, 550);
        Texture2Sprite(speedTEXT0, speedTEXT0Sprite, currentProject + "assets/sprites/Setup/speedTEXT0.png", 823, 574);
        Texture2Sprite(speedTEXT0cont, speedTEXT0contSprite, currentProject + "assets/sprites/Setup/speedTEXT0cont.png", 823, 574);
        Texture2Sprite(speedTEXT1, speedTEXT1Sprite, currentProject + "assets/sprites/Setup/speedTEXT1.png", 890, 574);
        Texture2Sprite(speedTEXT1cont, speedTEXT1contSprite, currentProject + "assets/sprites/Setup/speedTEXT1cont.png", 890, 574);
        Texture2Sprite(speedTEXT2, speedTEXT2Sprite, currentProject + "assets/sprites/Setup/speedTEXT2.png", 1030, 574);
        Texture2Sprite(speedTEXT2cont, speedTEXT2contSprite, currentProject + "assets/sprites/Setup/speedTEXT2cont.png", 1030, 574);
        Texture2Sprite(setupTextBACK, setupTextBACKSprite, currentProject + "assets/sprites/Setup/textBACK.png", 750, 675);
        Texture2Sprite(setupTextBACKpressed, setupTextBACKpressedSprite, currentProject + "assets/sprites/Setup/textBACKpressed.png", 750, 675);
        Texture2Sprite(textBACKSFXMSC, textBACKSFXMSC0Sprite, currentProject + "assets/sprites/Setup/textBACKSFXMSC.png", 750, 300);
        Texture2Sprite(textBACKSFXMSC, textBACKSFXMSC1Sprite, currentProject + "assets/sprites/Setup/textBACKSFXMSC.png", 750, 425);
        Texture2Sprite(textBACKSFXMSCpressed, textBACKSFXMSC0pressedSprite, currentProject + "assets/sprites/Setup/textBACKSFXMSCpressed.png", 750, 300);
        Texture2Sprite(textBACKSFXMSCpressed, textBACKSFXMSC1pressedSprite, currentProject + "assets/sprites/Setup/textBACKSFXMSCpressed.png", 750, 425);
        Texture2Sprite(setupback, setupbackSprite, currentProject + "assets/sprites/Setup/setupback.png", 849, 699);
        Texture2Sprite(setupbackCont, setupbackContSprite, currentProject + "assets/sprites/Setup/setupbackCont.png", 849, 699);
        Texture2Sprite(backgroundg, backgroundgSprite, currentProject + "assets/sprites/backgroundg.png", 720, 260);
        Texture2Sprite(resume, resumeSprite, currentProject + "assets/sprites/resume.png", 778, 322);
        Texture2Sprite(resumeCont, resumeContSprite, currentProject + "assets/sprites/resumeCont.png", 778, 322);
        Texture2Sprite(GREENbackground, GREENbackgroundSprite, currentProject + "assets/sprites/INFMode/1GREENbackground.png");
        Texture2Sprite(BLUEbackground, BLUEbackgroundSprite, currentProject + "assets/sprites/INFMode/2BLUEbackground.png");
        Texture2Sprite(PURPLEbackground, PURPLEbackgroundSprite, currentProject + "assets/sprites/INFMode/3PURPLEbackground.png");
        Texture2Sprite(REDbackground, REDbackgroundSprite, currentProject + "assets/sprites/INFMode/4REDbackground.png");
        Texture2Sprite(ORANGEbackground, ORANGEbackgroundSprite, currentProject + "assets/sprites/INFMode/5ORANGEbackground.png");
        Texture2Sprite(YELLOWbackground, YELLOWbackgroundSprite, currentProject + "assets/sprites/INFMode/6YELLOWbackground.png");
        Texture2Sprite(BLUEsnakeHead, BLUEsnakeHeadSprite, currentProject + "assets/sprites/INFMode/BLUEsnakeHead.png");
        Texture2Sprite(BLUEsnakeBody, BLUEsnakeBodySprite, currentProject + "assets/sprites/INFMode/BLUEsnakeBody.png");
        Texture2Sprite(PURPLEsnakeHead, PURPLEsnakeHeadSprite, currentProject + "assets/sprites/INFMode/PURPLEsnakeHead.png");
        Texture2Sprite(PURPLEsnakeBody, PURPLEsnakeBodySprite, currentProject + "assets/sprites/INFMode/PURPLEsnakeBody.png");
        Texture2Sprite(REDsnakeHead, REDsnakeHeadSprite, currentProject + "assets/sprites/INFMode/REDsnakeHead.png");
        Texture2Sprite(REDsnakeBody, REDsnakeBodySprite, currentProject + "assets/sprites/INFMode/REDsnakeBody.png");
        Texture2Sprite(ORANGEsnakeHead, ORANGEsnakeHeadSprite, currentProject + "assets/sprites/INFMode/ORANGEsnakeHead.png");
        Texture2Sprite(ORANGEsnakeBody, ORANGEsnakeBodySprite, currentProject + "assets/sprites/INFMode/ORANGEsnakeBody.png");
        Texture2Sprite(YELLOWsnakeHead, YELLOWsnakeHeadSprite, currentProject + "assets/sprites/INFMode/YELLOWsnakeHead.png");
        Texture2Sprite(YELLOWsnakeBody, YELLOWsnakeBodySprite, currentProject + "assets/sprites/INFMode/YELLOWsnakeBody.png");
        Texture2Sprite(null, nullSprite, currentProject + "assets/sprites/null.png");
        Texture2Sprite(textagain, textagainSprite, currentProject + "assets/sprites/textagain.png", 825, 447);
        Texture2Sprite(textagaincontain, textagaincontainSprite, currentProject + "assets/sprites/textagaincontain.png", 825, 447);
        Texture2Sprite(ARChole, ARCholeSprite1, currentProject + "assets/sprites/ARChole.png");
        Texture2Sprite(ARChole, ARCholeSprite2, currentProject + "assets/sprites/ARChole.png");
        Texture2Sprite(foodextra, foodextraSprite, currentProject + "assets/sprites/foodextra.png");
        Texture2Sprite(wasted, wastedSprite, currentProject + "assets/sprites/wasted.png", 777, 322);
        Texture2Sprite(youwon, youwonSprite, currentProject + "assets/sprites/wasted.png", 759, 322);
        Texture2Sprite(oneBIGwhite, oneBIGwhiteSprite, currentProject + "assets/sprites/1oneBIGwhite.png");
        Texture2Sprite(twoBIGwhite, twoBIGwhiteSprite, currentProject + "assets/sprites/2twoBIGwhite.png");
        Texture2Sprite(threeBIGwhite, threeBIGwhiteSprite, currentProject + "assets/sprites/3threeBIGwhite.png");
        Texture2Sprite(loginback, loginbackSprite, currentProject + "assets/sprites/loginback.png", 1230, 550);
        Texture2Sprite(loginbackpressed, loginbackpressedSprite, currentProject + "assets/sprites/loginbackpressed.png", 1230, 550);
        Texture2Sprite(loginfront, loginfrontSprite, currentProject + "assets/sprites/loginfront.png", 1230, 550);
        Texture2Sprite(loginfrontcont, loginfrontcontSprite, currentProject + "assets/sprites/loginfrontcont.png", 1230, 550);
        Texture2Sprite(logoutback, logoutbackSprite, currentProject + "assets/sprites/logoutback.png", 1230, 550);
        Texture2Sprite(logoutbackpressed, logoutbackpressedSprite, currentProject + "assets/sprites/logoutbackpressed.png", 1230, 550);
        Texture2Sprite(logoutfront, logoutfrontSprite, currentProject + "assets/sprites/logoutfront.png", 1230, 550);
        Texture2Sprite(logoutfrontcont, logoutfrontcontSprite, currentProject + "assets/sprites/logoutfrontcont.png", 1230, 550);
        Texture2Sprite(logreg, logregSprite, currentProject + "assets/sprites/logreg.png", 720, 385);
        Texture2Sprite(textlogin, textloginSprite, currentProject + "assets/sprites/textlogin.png", 865, 447);
        Texture2Sprite(textlogincont, textlogincontSprite, currentProject + "assets/sprites/textlogincont.png", 865, 447);
        Texture2Sprite(textsignin, textsigninSprite, currentProject + "assets/sprites/textsignin.png", 786, 572);
        Texture2Sprite(textsignincont, textsignincontSprite, currentProject + "assets/sprites/textsignincont.png", 786, 572);
        Texture2Sprite(logregESC, logregESCSprite, currentProject + "assets/sprites/logregESC.png", 754, 429);
        Texture2Sprite(logregESCcont, logregESCcontSprite, currentProject + "assets/sprites/logregESCcont.png", 754, 429);
        Texture2Sprite(logregESCback, logregESCbackSprite, currentProject + "assets/sprites/logregESCBACK.png", 750, 424);
        Texture2Sprite(logregESCbackpressed, logregESCbackpressedSprite, currentProject + "assets/sprites/logregESCBACKpressed.png", 750, 425);
        Texture2Sprite(textloginBACK, textloginBACKSprite, currentProject + "assets/sprites/textloginBACK.png", 830, 425);
        Texture2Sprite(textloginBACKpressed, textloginBACKpressedSprite, currentProject + "assets/sprites/textloginBACKpressed.png", 830, 425);
        Texture2Sprite(logregback2, logregback2Sprite, currentProject + "assets/sprites/logregback2.png", 720, 385);
        Texture2Sprite(textlog, textlogSprite, currentProject + "assets/sprites/textlog.png", 834, 442);
        Texture2Sprite(textpass, textpassSprite, currentProject + "assets/sprites/textpass.png", 847, 584);
        Texture2Sprite(logregbackno, logregbacknoSprite, currentProject + "assets/sprites/logregbackno.png", 720, 707);
        Texture2Sprite(logregbacknopressed, logregbacknopressedSprite, currentProject + "assets/sprites/logregbacknopressed.png", 720, 707);
        Texture2Sprite(logregbackyes, logregbackyesSprite, currentProject + "assets/sprites/logregbackyes.png", 960, 707);
        Texture2Sprite(logregbackyespressed, logregbackyespressedSprite, currentProject + "assets/sprites/logregbackyespressed.png", 960, 707);
        Texture2Sprite(reg, regSprite, currentProject + "assets/sprites/reg.png", 997, 728);
        Texture2Sprite(regcont, regcontSprite, currentProject + "assets/sprites/regcont.png", 997, 728);
        Texture2Sprite(log, logSprite, currentProject + "assets/sprites/log.png", 997, 728);
        Texture2Sprite(logcont, logcontSprite, currentProject + "assets/sprites/logcont.png", 997, 728);
...
class SnakeGame {
    ...
    SnakeGame(UserInterface& UserInterface, AudioManager& AudioManager, ConfigManager& ConfigManager, ServerClient& serverClient) : cAudioManager{AudioManager}, cUserInterface{UserInterface}, cConfigManager{ConfigManager}, serverClient{serverClient}, gameScore{1}, snakeInt{0}, backgroundInt{5}, foodInt{0}, isCLSModeStarted{false}, isINFModeStarted{false}, isARCModeStarted{false}, isFoodEaten{false}, isSnakeGrowing{false}, isGameStarted{false}, isNextLevel{false}, youWon{false}, youLose{false}, isGameRestarted{true}, mSdirection{1, 0}, direction{1, 0}, elapsedTime{0.0f}, preGameElapsed{0.f}, oneFloat{0.f}, twoFloat{0.f}, threeFloat{0.f}, preGameTimerSpeed{1416.f}, playArea{120, 208, 1680, 760}, genX1{seedGen()}, genY1{seedGen()}, genX2{seedGen()}, genY2{seedGen()}, genX3{seedGen()}, genY3{seedGen()}, distX1{0, 41}, distY1{0, 18}, distX2{0, 35}, distY2{0, 12}, distX3{0, 35}, distY3{0, 12} {
        food.loadFromFile(cUserInterface.currentProject + "assets/sprites/food.png");
        snakeHead.loadFromFile(cUserInterface.currentProject + "assets/sprites/snakeHead.png");
        snakeBodyTexture.loadFromFile(cUserInterface.currentProject + "assets/sprites/snakeBody.png");
